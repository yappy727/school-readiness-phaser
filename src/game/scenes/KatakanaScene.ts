...
export default class KatakanaScene extends Phaser.Scene {
  ...
  private showGameCompleteMessage(): void {
    ...
    // ボタンエリア
    const buttonY = this.cameras.main.centerY + 60;
  ...
  private drawApron(x: number, y: number): void {
    ...
    for (let i = 0; i < 5; i++) {
      ...
      this.illustrationDisplay.lineTo(x - 6, laceY - 2, x, laceY);
      this.illustrationDisplay.lineTo(x + 6, laceY - 2, x + 12, laceY);
      this.illustrationDisplay.strokePath();
    }
  }
  ...
  private drawOrange(x: number, y: number): void {
    ...
    this.illustrationDisplay.lineTo(x - 8, y - 25, x - 12, y - 18);
    this.illustrationDisplay.lineTo(x - 8, y - 15, x - 3, y - 20);
    this.illustrationDisplay.closePath();
    this.illustrationDisplay.fillPath();
  ...
  private drawSoup(x: number, y: number): void {
    ...
    for (let i = 0; i < 4; i++) {
      ...
      this.illustrationDisplay.lineTo(x - 8 + i * 7, y - 15, x - 6 + i * 7, y - 10);
      this.illustrationDisplay.lineTo(x - 4 + i * 7, y - 20, x - 2 + i * 7, y - 15);
      this.illustrationDisplay.strokePath();
    }
  ...
  private drawSweater(x: number, y: number): void {
    ...
    for (let i = 0; i < 3; i++) {
      ...
      for (let j = 0; j < 6; j++) {
        const waveY = y - 5 + j * 5;
        this.illustrationDisplay.lineTo(cableX + 3, waveY + 2, cableX, waveY + 5);
      }
      this.illustrationDisplay.strokePath();
    }
  ...
  private drawNoodle(x: number, y: number): void {
    ...
    this.illustrationDisplay.lineTo(x - 5, y - 2, x, y + 8);
    this.illustrationDisplay.lineTo(x + 5, y + 15, x + 8, y + 10);
    this.illustrationDisplay.strokePath();
    
    // 麺の束2
    this.illustrationDisplay.beginPath();
    this.illustrationDisplay.moveTo(x + 8, y + 2);
    this.illustrationDisplay.lineTo(x + 3, y + 10, x - 3, y + 6);
    this.illustrationDisplay.lineTo(x - 8, y + 12, x - 5, y + 15);
    this.illustrationDisplay.strokePath();
    
    // 麺の束3
    this.illustrationDisplay.beginPath();
    this.illustrationDisplay.moveTo(x - 5, y);
    this.illustrationDisplay.lineTo(x, y + 8, x + 6, y + 5);
    this.illustrationDisplay.lineTo(x + 12, y + 12, x + 10, y + 18);
    this.illustrationDisplay.strokePath();
    ...
    for (let i = 0; i < 3; i++) {
      ...
      this.illustrationDisplay.lineTo(x - 6 + i * 8, y - 15, x - 4 + i * 8, y - 20);
      this.illustrationDisplay.strokePath();
    }
  }
  ...
  private drawHamburger(x: number, y: number): void {
    ...
    this.illustrationDisplay.lineTo(x - 8, y - 6, x - 4, y - 2);
    this.illustrationDisplay.lineTo(x, y + 2, x + 4, y - 2);
    this.illustrationDisplay.lineTo(x + 8, y - 6, x + 12, y - 2);
  ...
  private drawMouse(x: number, y: number): void {
    ...
    this.illustrationDisplay.lineTo(x + 15, y + 20, x + 25, y + 10);
    this.illustrationDisplay.strokePath();
  ...
  private drawMelon(x: number, y: number): void {
    ...
    this.illustrationDisplay.lineTo(x + 8, y - 15, x + 6, y - 8);
    this.illustrationDisplay.lineTo(x + 10, y - 5, x + 12, y - 10);
    this.illustrationDisplay.strokePath();
    ...
    this.illustrationDisplay.lineTo(x + 12, y - 8, x + 10, y - 5);
    this.illustrationDisplay.lineTo(x + 8, y - 7, x + 8, y - 10);
    this.illustrationDisplay.fillPath();
  ...
  private drawMonitor(x: number, y: number): void {
    ...
    this.illustrationDisplay.lineTo(x + 15, y + 22, x + 20, y + 15);
    this.illustrationDisplay.strokePath();
  ...
  private drawLight(x: number, y: number): void {
    ...
    this.illustrationDisplay.lineTo(x, y - 5, x + 4, y - 10);
    this.illustrationDisplay.strokePath();
    
    this.illustrationDisplay.beginPath();
    this.illustrationDisplay.moveTo(x - 3, y - 3);
    this.illustrationDisplay.lineTo(x, y + 1, x + 3, y - 3);
    this.illustrationDisplay.strokePath();
    ...
    this.illustrationDisplay.lineTo(x + 15, y + 25, x + 20, y + 15);
    this.illustrationDisplay.strokePath();
  ...
  private drawLemon(x: number, y: number): void {
    ...
    this.illustrationDisplay.beginPath();
    this.illustrationDisplay.moveTo(x - 2, y - 12);
    this.illustrationDisplay.lineTo(x - 5, y - 15, x - 3, y - 18);
    this.illustrationDisplay.lineTo(x - 1, y - 16, x - 2, y - 12);
    this.illustrationDisplay.fillPath();
